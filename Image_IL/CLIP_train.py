...
model_save_dir = str(_IL_OUT_DIR / task_name / f"CLIP_{view_name}_view" / "Model")
...
if args.use_wandb:
    wandb.init(project=args.wandb_project, name=(args.wandb_name or f"CLIP_{task_name}_{view_name}_view"))
